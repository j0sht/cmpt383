		 ...
		 (if (number? n)
	      ...
	      ((= 3 expr-len)
	       (let* ((operand1 (first expr))
		      ...
		      (simplified-o1 (simplify operand1))
		      (simplified-o2 (simplify operand2))
		      (s1-is-lst (list? simplified-o1))
		      (s2-is-lst (list? simplified-o2))
		      (lst (list simplified-o1
				 operator
				 simplified-o2)))
		 (cond ((and plus o1-zero) simplified-o2)
		       ((and plus o2-zero) simplified-o1)
		       ((and mult (or o1-zero o2-zero)) 0)
		       ((and mult o1-one) simplified-o2)
		       ((and mult o2-one) simplified-o1)
		       ((and div o2-one) simplified-o1)
		       ((and minus o2-zero) simplified-o1)
		       ((and minus (equal? operand1 operand2)) 0)
		       ((and exp o2-zero) 1)
		       ((and exp o2-one) simplified-o1)
		       ((and exp o1-one) 1)
